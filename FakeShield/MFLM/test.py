...
def compound_image(image_path, mask_path):
...
if __name__ == "__main__":
    ...
    for input_image, input_text in DTE_FDM_output:
        ...
        #     filename = 'fakeshield_' + os.path.basename(input_image)
        #     save_path = os.path.join(output_path, filename)
        #     shutil.copy(input_image, save_path)
        #     continue
        ...
        # output_image.show()
        mask_path = os.path.join(output_path, 'mask_' + filename)
        save_path = os.path.join(output_path, 'fakeshield_' + os.path.splitext(filename)[0] + '.png')
        output_image.save(mask_path)
        output_image = compound_image(input_image, mask_path)
